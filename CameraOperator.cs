...
namespace DeviceSource
{
    ...
    using OutputExdelegate = MyCamera.cbOutputExdelegate;
    ...
    class CameraOperator
    {
        ...
        /****************************************************************************
         * @fn           RegisterImageCallBackForRGB
         * @brief        注册取流回调函数
         * @param        CallBackFunc          IN        回调函数
         * @param        pUser                 IN        用户参数
         * @return       成功：0；错误：-1
         ****************************************************************************/
        public int RegisterImageCallBackForRGB(OutputExdelegate CallBackFunc, IntPtr pUser)
        {
            int nRet;
            nRet = m_pCSI.MV_CC_RegisterImageCallBackForRGB_NET(CallBackFunc, pUser);
            if (MyCamera.MV_OK != nRet)
            {
                return CO_FAIL;
            }
